...
JungleBoss.prototype.preload = function () {
    game.load.image('tileset', './jungle/tileset.png');
    game.load.tilemap('jungleBoss', './jungle/jungleBoss.json', null, Phaser.Tilemap.TILED_JSON);
}

JungleBoss.prototype.create = function () {
    map = game.add.tilemap('jungleBoss');
